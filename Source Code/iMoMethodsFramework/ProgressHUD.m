...
{
	[self shared].interaction = YES;
	[[self shared] hudMake:status image:[UIImage imageNamed:@"progresshud-success" inBundle:mainFrameBundle()] spin:NO hide:YES];
}
...
{
	[self shared].interaction = YES;
	[[self shared] hudMake:status image:[UIImage imageNamed:@"progresshud-error" inBundle:mainFrameBundle()] spin:NO hide:YES];
}
